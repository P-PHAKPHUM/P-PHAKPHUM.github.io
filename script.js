let githubUser = 'P-PHAKPHUM'
let repo = 'P-PHAKPHUM.github.io'
let imgFolder = 'logo'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbx-hMLXLIxYVMotmgdPmqA-Gb_ISL266nBkVrwUyLf2FVR04HbdFgS_PX6E_DJT8sSFaw/exec');
